...
const time = moment.tz('Asia/Jakarta').format('dddd') + ', ' + moment.tz('Asia/Jakarta').format('LL')
...
break
case 'scbotvip':{
const aoakwokwo = `Silahkan Download : https://cutt.ly/iLHkSus`
reply(aoakwokwo)
}
break
case 'convertmenu':{
...
if (args.length < 1) return reply(`Contoh : ${prefix+order} 6282118022072`)
